...
for skill in project-map safe-implementation test-first precommit-review memory-retrieval docs-writer ai-coding-rules caveman diagnose grill-with-docs design-md plan-eng-review office-hours investigate qa-web web-verify setup-deploy pdf skill-creator docx xlsx; do
...
if [ "$skill_count" = "21" ]; then pass "Skill count: 21"; else fail "Expected 21 skills, found $skill_count"; fi
