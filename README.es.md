...
### Características Principales (v1.12.0)
...
- **18 skills** para análisis, implementación, validación, memoria, documentación, debugging, alignment, comunicación, design.md, revisión de planes de ingeniería, framing de producto, investigación de causa raíz, QA web sistemático, verificación web runtime-agnóstica, detección de plataforma de deploy y procesamiento de PDF (7 adaptadas de upstream: 6 de garrytan/gstack + 1 de anthropics/skills)
