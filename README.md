...
**v1.15.0 + graphify cherry-pick (knowledge graph builder with opt-in uv tool install)**
...
- **22 skills** for analysis, implementation, validation, memory, documentation, debugging, alignment, communication, design.md, plan engineering review, product framing, root-cause investigation, web QA, runtime-agnostic web verify, deploy platform detection, PDF processing, skill authoring, Word documents, Excel spreadsheets, and knowledge graph building (11 adapted from upstream: 6 from garrytan/gstack + 4 from anthropics/skills + 1 from safishamsi/graphify)
